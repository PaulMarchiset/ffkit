          ...
          <button
            ...
            className={cn(
              ...
              activeCategory === cat
                ...
                : "text-muted border-transparent hover:text-[#E8E5DC] hover:border-white/10",
            )}
          >
            {cat}
          </button>
          ...
          <button
            ...
            className={cn(
              ...
              activeId === t.id
                ...
                : "text-subtle border-white/8 hover:text-[#E8E5DC] hover:border-white/15 hover:bg-white/5",
            )}
          >
            {t.label}
          </button>
